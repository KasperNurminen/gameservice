...
from gameservice.views import Main, GameDetail, Register, Developer, DeveloperEdit, DeveloperCreate, DeveloperDelete, DeveloperDetails, Purchase, PaymentSuccess, PaymentFailed, Profile, activate_account, emailConfirmation, ScoreView, SaveDataView
