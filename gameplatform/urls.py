...
from gameservice.views import Main, GameDetail, Register, Developer, DeveloperEdit, DeveloperCreate, DeveloperDelete, DeveloperDetails, Purchase, PaymentSuccess, PaymentFailed, Profile, activate_account, emailConfirmation
...
urlpatterns = [
    ...
    path('emailconfirmation/', emailConfirmation.as_view(), name="emailconfirmation"),
