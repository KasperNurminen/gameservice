...
from gameservice.views import ScoreView, SaveDataView, Main, GameDetail, Register, Developer, DeveloperEdit, DeveloperCreate, DeveloperDelete, DeveloperDetails, Purchase, PaymentSuccess, PaymentFailed, emailConfirmation, Profile, activate_account
